...
Converted to JAX by Jeff Jennings (2024)
...
def transferFunction(x):
    r = 1.0*jnp.exp( -(x - 4.0)**2/1.0 ) +  0.1*jnp.exp( -(x - 2.0)**2/0.1 ) +  0.1*jnp.exp( -(x - -3.0)**2/0.5 )
    g = 1.0*jnp.exp( -(x - 4.0)**2/1.0 ) +  1.0*jnp.exp( -(x - 2.0)**2/0.1 ) +  0.1*jnp.exp( -(x - -3.0)**2/0.5 )
    b = 0.1*jnp.exp( -(x - 4.0)**2/1.0 ) +  0.1*jnp.exp( -(x - 2.0)**2/0.1 ) +  1.0*jnp.exp( -(x - -3.0)**2/0.5 )
    a = 0.6*jnp.exp( -(x - 4.0)**2/1.0 ) +  0.1*jnp.exp( -(x - 2.0)**2/0.1 ) + 0.01*jnp.exp( -(x - -3.0)**2/0.5 )
